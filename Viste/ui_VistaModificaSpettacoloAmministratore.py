...
################################################################################
## Form generated from reading UI file 'VistaModificaSpettacoloAmministratore.ui'
##
...
class Ui_VistaModificaSpettacoloAmministratore(object):
    def setupUi(self, VistaModificaSpettacoloAmministratore):
        if not VistaModificaSpettacoloAmministratore.objectName():
            VistaModificaSpettacoloAmministratore.setObjectName(u"VistaModificaSpettacoloAmministratore")
        VistaModificaSpettacoloAmministratore.resize(790, 499)
        self.Sfondo = QLabel(VistaModificaSpettacoloAmministratore)
...
"}")
        ...
        self.labelTitoloPrincipale = QLabel(VistaModificaSpettacoloAmministratore)
...
"}")
        ...
        QMetaObject.connectSlotsByName(VistaModificaSpettacoloAmministratore)
    # setupUi

    def retranslateUi(self, VistaModificaSpettacoloAmministratore):
        VistaModificaSpettacoloAmministratore.setWindowTitle(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Modifica Spettacolo - CineMax", None))
        self.Sfondo.setText("")
        self.labelIconaFoto.setText("")
        self.labelTitolo.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Titolo:", None))
        self.labelTitoloPrincipale.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Modifica Spettacolo", None))
        self.labelGenere.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Genere:", None))
        self.labelOrarioInizio.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Orario Inizio:", None))
        self.labelSala.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Sala:", None))
        self.labelData.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Data:", None))
        self.labelOrarioFine.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Orario Fine:", None))
        self.labelDurata.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Durata:", None))
        self.lineEditTitolo.setText("")
        self.lineEditGenere.setText("")
        self.lineEditDurata.setText("")
        self.pushButtonConferma.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Conferma", None))
        self.pushButtonAnnulla.setText(QCoreApplication.translate("VistaModificaSpettacoloAmministratore", u"Annulla", None))
