...
"}")
        ...
        self.labelTitoloPrincipale.setGeometry(QRect(180, 30, 181, 71))
        font1 = QFont()
...
"}")
        ...
        self.labelPrezzoProdotto.setGeometry(QRect(30, 360, 81, 20))
...
"}")
        ...
        self.labelPrezzoPuntiProdotto.setGeometry(QRect(180, 360, 121, 20))
