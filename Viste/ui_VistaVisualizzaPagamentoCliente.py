...
"}")
        ...
        self.labelIconaRicevuta.setGeometry(QRect(10, 10, 171, 171))
        self.labelIconaRicevuta.setPixmap(QPixmap(u"Viste/Immagini/RicevutaIconCliente.png"))
        self.labelIconaRicevuta.setScaledContents(True)
        self.labelTitolo = QLabel(VistaVisualizzaPagamentoCliente)
        self.labelTitolo.setObjectName(u"labelTitolo")
        self.labelTitolo.setGeometry(QRect(180, 30, 211, 71))
        font1 = QFont()
...
"}")
        ...
        self.labelDataPagamento.setGeometry(QRect(30, 220, 101, 20))
...
"}")
        ...
        self.labelOraPagamento.setGeometry(QRect(180, 220, 111, 20))
...
"}")
        ...
        self.labelImportoPuntiPagamento = QLabel(VistaVisualizzaPagamentoCliente)
        self.labelImportoPuntiPagamento.setObjectName(u"labelImportoPuntiPagamento")
        self.labelImportoPuntiPagamento.setGeometry(QRect(180, 360, 131, 20))
        self.labelImportoPuntiPagamento.setStyleSheet(u"QLabel {\n"
"    color: #965A00;\n"
"}")
        self.labelId = QLabel(VistaVisualizzaPagamentoCliente)
        self.labelId.setObjectName(u"labelId")
        self.labelId.setGeometry(QRect(180, 100, 101, 20))
...
"}")
        ...
        self.labelIdPagamento = QLabel(VistaVisualizzaPagamentoCliente)
        self.labelIdPagamento.setObjectName(u"labelIdPagamento")
        self.labelIdPagamento.setGeometry(QRect(180, 130, 121, 20))
