...
################################################################################
## Form generated from reading UI file 'VistaModificaProdottoAmministratore.ui'
##
...
class Ui_VistaModificaProdottoAmministratore(object):
    def setupUi(self, VistaModificaProdottoAmministratore):
        if not VistaModificaProdottoAmministratore.objectName():
            VistaModificaProdottoAmministratore.setObjectName(u"VistaModificaProdottoAmministratore")
        VistaModificaProdottoAmministratore.resize(790, 499)
        self.Sfondo = QLabel(VistaModificaProdottoAmministratore)
...
"}")
        ...
        self.labelTitoloPrincipale = QLabel(VistaModificaProdottoAmministratore)
...
"}")
        ...
        self.labelErroreIngredienti = QLabel(VistaModificaProdottoAmministratore)
...
"}")
        ...
        self.retranslateUi(VistaModificaProdottoAmministratore)

        QMetaObject.connectSlotsByName(VistaModificaProdottoAmministratore)
    # setupUi

    def retranslateUi(self, VistaModificaProdottoAmministratore):
        VistaModificaProdottoAmministratore.setWindowTitle(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Modifica Prodotto - CineMax", None))
        self.Sfondo.setText("")
        self.labelIconaFotoAmministratore.setText("")
        self.labelNome.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Nome:", None))
        self.labelTitoloPrincipale.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Modifica Prodotto", None))
        self.labelIngredienti.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Ingredienti:", None))
        self.labelDisponibile.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Disponibilit\u00e0:", None))
        self.labelAllergeni.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Allergeni:", None))
        self.labelPrezzo.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Prezzo:", None))
        ...
        self.pushButtonConferma.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Conferma", None))
        self.pushButtonAnnulla.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Annulla", None))
        self.checkBoxAllergene5.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Soia", None))
        ...
        self.labelPrezzoPunti.setText(QCoreApplication.translate("VistaModificaProdottoAmministratore", u"Prezzo in Punti:", None))
